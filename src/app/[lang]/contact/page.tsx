  ...
  return (
    <div className="flex-grow">
      <section className="relative min-h-screen pb-[70px] pt-[170px] lg:pt-[85px] flex flex-col justify-start overflow-hidden z-[1]">
        ...
        <div className="absolute top-[160px] sm:top-[160px] lg:top-[160px] left-[15px] sm:left-[20px] lg:left-[25px] right-[15px] sm:right-[20px] lg:right-[25px] bottom-[70px] bg-white rounded-[12px] sm:rounded-[16px] lg:rounded-[20px] z-[3] opacity-50 overflow-hidden">
          {/* SVG Background */}
