        ...
        <div className="container mx-auto px-4 relative z-[5] flex flex-col items-center justify-start h-full pt-[40px] sm:pt-[60px] lg:pt-[175px]">
          <div className="w-full max-w-[1400px] mx-auto relative px-3 sm:px-4 lg:px-6">
            <div className="relative flex flex-col items-center z-[6]">
              ...
              >
                <h1 className="font-nunito text-center text-[#0b0b0b] font-medium text-[28px] xs:text-[34px] sm:text-[42px] md:text-[48px] lg:text-[53px] leading-none whitespace-nowrap">
              ...
              {/* Cards */}
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mt-8 sm:mt-10 lg:mt-16 w-full mb-6 px-3 sm:px-4">
                {/* Email Card */}
              ...
              <div className="flex items-center justify-center gap-4 mt-0 mb-6 md:hidden">
                {/* LinkedIn */}
                <a
                  href="https://www.linkedin.com"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-[22px] h-[22px] relative flex items-center justify-center"
                >
                ...
                <a
                  ...
                  className="w-[17px] h-[17px] relative flex items-center justify-center"
                >
                  <svg width="17" height="17" viewBox="0 0 31 31" fill="none" xmlns="http://www.w3.org/2000/svg">
