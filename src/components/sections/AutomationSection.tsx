          ...
          <div className="flex flex-col lg:flex-row items-center">
            ...
            <div className="w-full lg:w-1/2 lg:absolute lg:left-[-10.3vw] lg:top-1/2 lg:-translate-y-1/2">
              <div className="relative w-full max-w-[680px] mx-auto lg:mx-0">
                {/* Background layers */}
                <div className="absolute -right-4 lg:-right-8 -top-3 lg:-top-5 -bottom-3 lg:bottom-0 w-[calc(100%+32px)] lg:w-[calc(100%+64px)] bg-[#016EC6] rounded-xl" />
                <div className="absolute -right-2 lg:-right-4 top-6 lg:top-12 -bottom-1 lg:-bottom-3 w-[calc(100%+16px)] lg:w-[calc(100%+32px)] bg-[#f5faff] rounded-xl" />
            ...
            <div className="w-full lg:w-1/2 lg:ml-auto lg:max-w-[480px] mb-12 lg:mb-0">
              ...
              <Link 
                href="#"
                className="group inline-flex items-center bg-[#016EC6] text-white px-6 lg:px-[40.89px] py-4 lg:py-[20.44px] rounded-[13.01px] hover:opacity-90 transition-all duration-300 hover:scale-[1.02]"
              >
